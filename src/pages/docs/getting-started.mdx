...
![youtube command](https://i.ibb.co/9HMrzmh/image.png)
...
![youtube command parameters](https://i.ibb.co/jvpcDXr/image.png)
...
![choosing games to queue for in the menu](https://i.ibb.co/GFKDBPF/image.png)

6. Navigate to the `#queue` channel and click `Join queue`.

![choosing games to queue for in the menu](https://i.ibb.co/PGGLHZx/image.png)
